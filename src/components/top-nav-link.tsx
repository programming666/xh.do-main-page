...
export function TopNavLink({
  ...
  return (
    <NextLink
      href={href}
      className="glass-panel inline-flex h-11 items-center justify-center rounded-full px-5 text-sm font-medium text-foreground transition-transform duration-200 ease-out hover:scale-105"
    >
      {label}
    </NextLink>
  );
