-- AlterTable
ALTER TABLE "SocialLink" ADD COLUMN "imageUrl" TEXT;
...
INSERT INTO "new_SiteSettings" ("accentColor", "backgroundFallback", "createdAt", "githubUrl", "heroDarkImageUrl", "heroDarkPlaylist", "heroEffect", "heroImageIntervalMs", "heroLightImageUrl", "heroLightPlaylist", "heroMediaMode", "heroMediaPlaylist", "heroMediaType", "heroMediaUrl", "heroOverlayOpacity", "heroPosterUrl", "id", "logoMode", "logoUrl", "siteDomain", "siteName", "updatedAt") SELECT "accentColor", "backgroundFallback", "createdAt", "githubUrl", "heroDarkImageUrl", "heroDarkPlaylist", "heroEffect", "heroImageIntervalMs", "heroLightImageUrl", "heroLightPlaylist", "heroMediaMode", "heroMediaPlaylist", "heroMediaType", "heroMediaUrl", "heroOverlayOpacity", "heroPosterUrl", "id", "logoMode", "logoUrl", "siteDomain", "siteName", "updatedAt" FROM "SiteSettings";
